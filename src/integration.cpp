...
void integrate_shifted(const ElementType &aT, const ElementType &bT, const QuadratureType &quadRule,
    ...
    // compute intersection of inner element with the ball centered at the barycenter of the outer element
    baryCenter(aT.E, &aTbaryC[0]);
    Rdx = method_retriangulate(aTbaryC, bT, mesh, reTriangle_list, conf.is_placePointOnCap);
    ...
    if (!Rdx) {
        ...
        //[DEBUG]
        //printf("Local [%17.16e, %17.16e, %17.16e, %17.16e] \n", innerLocal[0], innerLocal[1], innerLocal[2], innerLocal[3]);
        //printf("Nonloc [%17.16e, %17.16e, %17.16e, %17.16e] \n", innerNonloc[0], innerNonloc[1], innerNonloc[2], innerNonloc[3]);
