...
integration_method = "exactBall" #"retriangulate" # "retriangulate" # "tensorgauss" "baryCenterRT" # "baryCenter"  # superSetBall #averageBall #subSetBall
is_PlacePointOnCap = False
averageWeights = [0.0, 1.0, 1.0]
quadrule_outer = "7" #  "vioreanu_rokhlin" # 7
quadrule_inner = "1"
tensorGaussDegree = 4
