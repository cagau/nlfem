...
def main(conf, kernel, load, pp = None):
    err_ = None
    data = {"h": [], "L2 Error": [], "Rates": [], "Assembly Time": [], "nV_Omega": [], "h_min": [], "h_max": []}
    ...
    for n in N:
        ...
        data["h_min"].append(mesh.h_min)
        data["h_max"].append(mesh.h_max)
...
if __name__ == "__main__":
    ...
    from testConfLinf import CONFIGURATIONS, KERNELS, LOADS
