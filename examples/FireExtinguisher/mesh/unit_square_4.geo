...
Ellipse(8889) = {0.5, 0.5, 0, 0.3, 0.2 , 0, 2*Pi};
Point(777) = {0.4, 0.5, 0, lc_coarse};
Point(7772) = {0.6, 0.5, 0, lc_coarse};
Point(7773) = {0.5, 0.5, 0, lc_coarse};
Point(7774) = {0.5, 0.6, 0, lc_coarse};
Point(7775) = {0.5, 0.4, 0, lc_coarse};
...
Point{7774} In Surface {20};
Point{7775} In Surface {20};
